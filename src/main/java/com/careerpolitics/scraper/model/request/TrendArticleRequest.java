...
public class TrendArticleRequest {
    ...
    @Min(1)
    @Max(720)
    @Schema(description = "Do not repeat same trend within this cooldown window (hours)", example = "168", minimum = "1", maximum = "720", defaultValue = "168")
    private int trendCooldownHours = 168;
